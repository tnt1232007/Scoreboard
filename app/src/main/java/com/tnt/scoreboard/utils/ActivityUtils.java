...
public final class ActivityUtils {
    ...
    public static Screen[] SCREENS = new Screen[]{
            new Screen(Game.State.NORMAL, View.VISIBLE,
                    ...
                    R.color.blue, R.color.blueBackground, R.drawable.ic_empty_games,
            ...
            new Screen(Game.State.ARCHIVE, View.GONE,
                    ...
                    R.color.orange, R.color.orangeBackground, R.drawable.ic_empty_archive,
            ...
            new Screen(Game.State.DELETE, View.GONE,
                    ...
                    R.color.teal, R.color.tealBackground, R.drawable.ic_empty_trash,
    ...
    public static class Screen implements Parcelable {
        ...
        public Screen(Game.State state, int fabVisible, int title, int menuLayout,
                      int colorPrimary, int colorAccent, int emptyBackground,
                      int emptyHeader, int emptyText) {
            this.STATE = state;
            this.TITLE = title;
